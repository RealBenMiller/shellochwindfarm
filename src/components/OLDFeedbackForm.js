    ...
    <>
      ...
      >
        ...
        <p>
          ...
          your feedback on the proposals by completing this short questionnaire.
          You can complete this electronically here or return it to us by email
          or post using the contact details at the end of the form.
        </p>
        ...
        <Form data-netlify="true" netlify name="feedbackform" method="POST">
          ...
          <Form.Group controlId="QuestionFour">
            <Form.Label
              ...
              `}
            >
              4. A Community Benefit Fund (as referenced on Exhibition Board 5)
              will be created to help fund projects in the local community. Do
              you support the creation of this fund?
            </Form.Label>
            {["radio"].map(type => (
              <div key={`inline-${type}`} className="mb-3">
                <Form.Check
          ...
          <Form.Group controlId="QuestionFive">
            ...
            >
              ...
              to collectively have up to 10% Community Ownership in the Shelloch
              Wind Farm through a Profit Sharing Agreement. If your local group
              falls within the ‘’Community of interest’’ (as referenced on
              Exhibition Board 6), would you like to receive further information
              on the Community Investment Opportunity?
            </Form.Label>
            {["radio"].map(type => (
              <div key={`inline-${type}`} className="mb-3">
                <Form.Check
            ...
            <Form.Label>
              Your capital is at risk if you invest. Investments are not covered
              by the Financial Services Compensation Scheme. For a full risk
              warning, please contact Steven Park and a representative from EDF
              Renewable Community Investment Ltd will contact you. EDF
              Renewables is a trading name of EDF Renewables Community
              Investment Limited which is an appointed representative of
              Resolution Compliance Limited which is authorised and regulated by
              the Financial Conduct Authority (FRN:574048)
            </Form.Label>
          </Form.Group>
          ...
          <Form.Group controlId="QuestionSeven">
            ...
            <Form.Label>
              Firstly, please tick the box(es) below that best reflect what you
              consider to be the{" "}
              <span
                css={css`
                  font-weight: bold;
        ...
        `}
          ...
          <p>
            ...
            This personal data will only be stored and processed for the purpose
            of compliance with our legal and regulatory obligations and only
            accessible by a limited number of employees who need to do so to
            carry out the requirements of their role. We will also securely
            delete or destroy your data as soon as we no longer need to store
            it. We are committed to safeguarding your privacy and to complying
            in full with the General Data Protection Regulation (GDPR) and our
            own internal Privacy Policy.
          </p>
